...
class SQLCipher(private val context: Context, private val scriptRuntime: ScriptRuntime) {

    fun open(name: String, password: String, version: Int, readOnly: Boolean, callback: DatabaseCipher.DatabaseCallback?): DatabaseCipher {
        return DatabaseCipher(context, scriptRuntime, name, version, password, readOnly, callback, TypeAdapterImpl())
    }

    private class TypeAdapterImpl : DatabaseCipher.TypeAdapter {
